    ...
    <TaskSlide
      ...
      solution={
        <>
          ...
          <p className="mb-3">
            В JS-бандле находим алгоритм подписи —
            ревёрсим функцию хэширования от строки <span className="font-mono">score + seed + uid</span> или используем дебаггер в браузере.
          </p>
          <p>
            Считаем подпись для нужного счёта,
